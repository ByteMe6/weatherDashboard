...
export function WheatherList() {
    const { wheatherData,
        ...
        seeWeklyData,
        seeHourlyWeather,
        deleteDay } = useContext(CityContext);
    ...
    const handleSeeHourlyWeather = (date) => {
        seeHourlyWeather(date)
    }
                        ...
                        return (
                            <li key={day.dt} className={style.wheatherList__item}>
                                ...
                                <div className={style.wheatherList__buttons}>
                                    <button onClick={() => handleSeeHourlyWeather(day.dt_txt)} className={style.wheatherList__button}>Hourly forecast</button>
                                ...
                                <div className={style.wheatherList__footer}>
                                    ...
                                    <button className={style.wheatherList__deleteBtn} onClick={() => deleteDay(day.dt_txt)}>
